...
class _ShowProductPageState extends State<ShowProductPage> {
  ...
  Future<String?> getList() async {
    ...
    products = [];
    var url =
        Uri.parse('https://laravel-backend-116.herokuapp.com/api/products');
...
// Define Laravel API for Deleting Produce
    var url = Uri.parse(
        'https://laravel-backend-116.herokuapp.com/api/products/$id');
...
// Check Status Code, then pop to the previous
  ...
  Future<void> logout() async {
    ...
    var url =
        Uri.parse('https://laravel-backend-116.herokuapp.com/api/logout');
